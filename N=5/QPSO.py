...
if __name__ == "__main__":
    df5 = pd.read_excel('D:/研究生/专业学习/灰色预测/要写/锂电池/NASAlidianchi/NASA.xlsx', sheet_name='B5')
    X1 = np.array(df5.iloc[:133, 0].tolist())
    X2 = np.array(df5.iloc[:133, 1].tolist())
    X3 = np.array(df5.iloc[:133, 2].tolist())
